...
public class TestDataForUniversity {
    ...
    private void createGroupsAndStudents() {
        ...
        objectFinder = new ObjectFinder(university);
        objectFinder.findGroupByName("MB - 1").addStudent(objectFinder.findStudentById(1));
        objectFinder.findGroupByName("MB - 1").addStudent(objectFinder.findStudentById(2));
        objectFinder.findGroupByName("MB - 2").addStudent(objectFinder.findStudentById(3));
        objectFinder.findGroupByName("MB - 2").addStudent(objectFinder.findStudentById(4));
        objectFinder.findGroupByName("MB - 3").addStudent(objectFinder.findStudentById(5));
        objectFinder.findGroupByName("MB - 3").addStudent(objectFinder.findStudentById(6));
        objectFinder.findGroupByName("MB - 4").addStudent(objectFinder.findStudentById(7));
        objectFinder.findGroupByName("MB - 4").addStudent(objectFinder.findStudentById(8));
        objectFinder.findGroupByName("MB - 5").addStudent(objectFinder.findStudentById(9));
        objectFinder.findGroupByName("MB - 5").addStudent(objectFinder.findStudentById(10));
        university.setGroups(groups);
    }
    ...
    private void createLectures() {
        ObjectFinder finder = new ObjectFinder(university);
